 ...
 * ставка ОПВР), иногда — в середине года. Число, вписанное прямо в формулу,
 ...
 *
 * Формула ОП Отбасы и методика ГЭСВ — такие же внешние допущения, как МРП:
 * их можно неверно понять, и они меняются. Версионируем и помечаем так же,
 * чтобы в интерфейсе было видно, на каком основании получено число.
 */
